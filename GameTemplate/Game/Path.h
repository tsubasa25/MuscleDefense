...
public:
	...
	void AddPoint(const Vector3& point)
	{
		...
		m_pointArraySmooth.push_back(Vector3::Zero);
	}
	/// <summary>
	/// パスを構築。
	/// </summary>
	...
	Vector3& GetDirection(int num) { return m_sectionArray[num].direction; }
	int GetSectionNo() { return m_sectionNo; }
	void SectionArrayPopBack(int num);
private:
	/// <summary>
	/// パスのセクション
	/// </summary>
	...
	std::vector<Vector3>    m_pointArraySmooth;
